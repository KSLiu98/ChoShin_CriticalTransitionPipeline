...
<!-- generated with COPASI 4.44 (Build 295) (http://www.copasi.org) at 2024-08-07T16:34:08Z -->
...
Sampling 200 random parameter sets, and 100 different initial condition sets per parameter sets, for sampling 20K times. The sampling of the initial conditions  range from 1e-6 to the data-informed maximum, with logarithmic sampling.
    </Comment>
    <ListOfCompartments>
...
<rdf:Description rdf:about="#Reaction_5">
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4650" name="FC" value="0.1"/>
          <Constant key="Parameter_4651" name="TH" value="0.1"/>
          <Constant key="Parameter_4653" name="N" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=Cho_Shin_LungCancer_GRN,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_275">
...
<rdf:Description rdf:about="#Reaction_6">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4652" name="k1" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Cho_Shin_LungCancer_GRN,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:Description rdf:about="#ModelParameterSet_1">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_19" name="Scan" type="scan" scheduled="false" updateModel="false">
      <Report reference="Report_22" target="Cho_Shin_LungCancer_GRN_15.txt" append="0" confirmOverwrite="1"/>
      <Problem>

...
<!-- generated with COPASI 4.44 (Build 295) (http://www.copasi.org) at 2024-08-07T20:05:05Z -->
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_1">
    ...
    <Comment>
      ODE model of lung cancer cells at the critical transition point, taken from Cho and Shin's manuscript "Critical transition and reversion of tumorigenesis". Used the exact parameter set specified by Cho and Shin. Ranges for initial network conditions likewise ranged from 1e-6 to maxima informed by the scRNA-seq data from Lambrechts et al. 2018, sampled logarithmically. Sampled 40000 random initial states.
    </Comment>
    <ListOfCompartments>
...
<rdf:Description rdf:about="#Reaction_0">
        ...
        <ListOfConstants>
          <Constant key="Parameter_5506" name="k1" value="4.0293"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#Reaction_1">
        ...
        <ListOfConstants>
          <Constant key="Parameter_5509" name="G" value="36.437"/>
          <Constant key="Parameter_4675" name="FC" value="50.764"/>
          <Constant key="Parameter_4676" name="TH" value="3.7388"/>
          <Constant key="Parameter_4679" name="N" value="2"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#Reaction_2">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4674" name="k1" value="0.73339"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Cho_Shin_LungCancer_GRN,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:Description rdf:about="#Reaction_3">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4678" name="G" value="94.764"/>
          <Constant key="Parameter_4677" name="FC1" value="48.834"/>
          <Constant key="Parameter_6923" name="TH1" value="29.777"/>
          <Constant key="Parameter_6924" name="N1" value="5"/>
          <Constant key="Parameter_6927" name="FC2" value="92.651"/>
          <Constant key="Parameter_6922" name="TH2" value="6.0194"/>
          <Constant key="Parameter_6926" name="N2" value="3"/>
          <Constant key="Parameter_6925" name="FC3" value="36.102"/>
          <Constant key="Parameter_4647" name="TH3" value="67.22"/>
          <Constant key="Parameter_4648" name="N3" value="4"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#Reaction_4">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4654" name="k1" value="0.63639"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Cho_Shin_LungCancer_GRN,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:Description rdf:about="#Reaction_5">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4646" name="G" value="58.436"/>
          <Constant key="Parameter_4650" name="FC" value="38.165"/>
          <Constant key="Parameter_4653" name="TH" value="2.5773"/>
          <Constant key="Parameter_4652" name="N" value="5"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=Cho_Shin_LungCancer_GRN,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_275">
...
<rdf:Description rdf:about="#Reaction_6">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4651" name="k1" value="0.01638"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Cho_Shin_LungCancer_GRN,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:Description rdf:about="#Reaction_7">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4649" name="G" value="73.576"/>
          <Constant key="Parameter_7507" name="FC" value="11.695"/>
          <Constant key="Parameter_7508" name="TH" value="9.6368"/>
          <Constant key="Parameter_7511" name="N" value="2"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=Cho_Shin_LungCancer_GRN,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_275">
...
<rdf:Description rdf:about="#Reaction_8">
        ...
        <ListOfConstants>
          <Constant key="Parameter_7506" name="k1" value="0.32857"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Cho_Shin_LungCancer_GRN,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:Description rdf:about="#Reaction_9">
        ...
        <ListOfConstants>
          <Constant key="Parameter_7510" name="G" value="52.016"/>
          <Constant key="Parameter_7509" name="FC" value="76.83"/>
          <Constant key="Parameter_6026" name="TH" value="4.79"/>
          <Constant key="Parameter_6027" name="N" value="5"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=Cho_Shin_LungCancer_GRN,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_275">
...
<rdf:Description rdf:about="#Reaction_10">
        ...
        <ListOfConstants>
          <Constant key="Parameter_6029" name="k1" value="0.32384"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Cho_Shin_LungCancer_GRN,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:Description rdf:about="#Reaction_11">
        ...
        <ListOfConstants>
          <Constant key="Parameter_6025" name="G" value="31.963"/>
          <Constant key="Parameter_6028" name="FC" value="58.55"/>
          <Constant key="Parameter_6510" name="TH" value="78.959"/>
          <Constant key="Parameter_6511" name="N" value="2"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=Cho_Shin_LungCancer_GRN,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_275">
...
<rdf:Description rdf:about="#Reaction_12">
        ...
        <ListOfConstants>
          <Constant key="Parameter_6513" name="k1" value="0.35657"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Cho_Shin_LungCancer_GRN,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:Description rdf:about="#Reaction_13">
        ...
        <ListOfConstants>
          <Constant key="Parameter_6509" name="G" value="7.6353"/>
          <Constant key="Parameter_6512" name="FC" value="78.563"/>
          <Constant key="Parameter_7345" name="TH" value="43.133"/>
          <Constant key="Parameter_7346" name="N" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=Cho_Shin_LungCancer_GRN,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_275">
...
<rdf:Description rdf:about="#Reaction_14">
        ...
        <ListOfConstants>
          <Constant key="Parameter_7348" name="k1" value="0.53837"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Cho_Shin_LungCancer_GRN,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:Description rdf:about="#Reaction_15">
        ...
        <ListOfConstants>
          <Constant key="Parameter_7344" name="G" value="39.92"/>
          <Constant key="Parameter_7347" name="FC1" value="85.693"/>
          <Constant key="Parameter_4926" name="TH1" value="4.0907"/>
          <Constant key="Parameter_4927" name="N1" value="4"/>
          <Constant key="Parameter_4929" name="FC2" value="93.561"/>
          <Constant key="Parameter_4925" name="TH2" value="8.1658"/>
          <Constant key="Parameter_4928" name="N2" value="2"/>
          <Constant key="Parameter_6777" name="FC3" value="92.464"/>
          <Constant key="Parameter_6778" name="TH3" value="59.781"/>
          <Constant key="Parameter_6780" name="N3" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_42" unitType="Default" scalingCompartment="CN=Root,Model=Cho_Shin_LungCancer_GRN,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_280">
...
<rdf:Description rdf:about="#ModelParameterSet_1">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_19" name="Scan" type="scan" scheduled="false" updateModel="false">
      <Report reference="Report_22" target="Cho_Shin_LungCancer_GRN_20.txt" append="0" confirmOverwrite="1"/>
      <Problem>
        <Parameter name="Subtask" type="unsignedInteger" value="0"/>
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            <Parameter name="Number of steps" type="unsignedInteger" value="40000"/>

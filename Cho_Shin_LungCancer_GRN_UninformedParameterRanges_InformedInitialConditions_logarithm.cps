...
<!-- generated with COPASI 4.44 (Build 295) (http://www.copasi.org) at 2024-08-07T17:17:54Z -->
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_1">
    ...
    <Comment>
      ODE model of lung cancer cells at the critical transition point, taken from Cho and Shin's manuscript "Critical transition and reversion of tumorigenesis". Sampled 200 random parameter sets. Ranges for parameter sampling were NOT informed by Cho and Shin's published parameter set, and were instead set assuming that we did not know what the appropriate range was. Ranges for initial network conditions likewise ranged from 1e-6 to a maximum as determined by examining the original lung cancer dataset, sampled logarithmically. Sampled 200 random initial states per parameter set.
    </Comment>
    <ListOfCompartments>
...
<rdf:Description rdf:about="#Reaction_5">
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4651" name="N" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=Cho_Shin_LungCancer_GRN,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_275">
...
<rdf:Description rdf:about="#Reaction_6">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4650" name="k1" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Cho_Shin_LungCancer_GRN,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:Description rdf:about="#ModelParameterSet_1">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_19" name="Scan" type="scan" scheduled="false" updateModel="false">
      <Report reference="Report_22" target="Cho_Shin_LungCancer_GRN_17.txt" append="0" confirmOverwrite="1"/>
      <Problem>
